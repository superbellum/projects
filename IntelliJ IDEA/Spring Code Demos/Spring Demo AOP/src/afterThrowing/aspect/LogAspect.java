package afterThrowing.aspect;

import afterThrowing.Account;
...
{
    @AfterThrowing(pointcut = "execution(* afterThrowing.dao.AccountDAO.findAccounts(..))", throwing = "exception")
    ...
    @AfterReturning(pointcut = "execution(* afterThrowing.dao.AccountDAO.findAccounts(..))", returning = "result")
